...
namespace ProjectGit.Controllers
{
    ...
    [ApiController]
    public class ManagmentsController : ControllerBase
    {
        private readonly ProjectGitContext _context;

        public ManagmentsController(ProjectGitContext context)
        {
            _context = context;
        }
